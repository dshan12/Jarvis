...
import requests
from Timer.autotimer import activate
import sqlite3
...
from Amazon import utils as u
from Deskcleaner import cleandesk as cd
...
conn = sqlite3.connect('memory/memmory.db')
try:
    ...
    if count == 50:
        ...
        if query == auth_key:
            ...
            if a == auth_key:
                ...
                speak(
                    "ok, you are not a authorized user. so you can't use this program. i am sorry but i am going offline ")
                quit()
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'search' in query:
            ...
            extPro = "I am going offline, Take care sir", "i am quitting", "Bye", "Bye. meet you soon.", "I am shutting down, Have a nice day", "Goodbye. meet u soon"
            ...
            a = input()
            speak(
                "Please put a folder inside the folder that you want to organize. This new folders name should be Sorted with a capital S")
            b = f"{a}/Sorted"
            cd.activate(a, b)
